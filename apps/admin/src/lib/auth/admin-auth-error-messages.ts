...
const ADMIN_AUTH_ERROR_MESSAGES: Record<AuthErrorCode, string> = {
  ...
  account_blocked: 'This admin account is blocked. Contact the platform owner.',
  session_invalid: 'Your session has expired. Please log in again.',
  session_revoked: 'This session is no longer active. Please log in again.',
  ...
  registration_session_failed:
    'Automatic sign-in could not be completed. Please log in.',
